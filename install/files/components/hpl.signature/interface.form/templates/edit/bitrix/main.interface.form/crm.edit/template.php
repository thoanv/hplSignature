...
?>
    <div class="bx-interface-form bx-crm-edit-form"><?
        if ($GLOBALS['USER']->IsAuthorized() && $arParams["SHOW_SETTINGS"] == true):?>
            ...
            <a href="javascript:void(0)"
               ...
               title="<?= htmlspecialcharsbx(GetMessage("interface_form_settings")) ?>"
               class="bx-context-button bx-form-menu"><span></span></a>
            </div><?
        endif;
        ?>
        ...
        <form name="form_<?= $arParams['FORM_ID'] ?>" id="form_<?= $arParams["FORM_ID"] ?>"
            ...
            <div class="webform-round-corners webform-main-fields">
                ...
                foreach ($arEmphasizedFields as &$field):
                    ...
                    <div class="bx-crm-edit-title-label"><? if ($required):?><span class="required">*</span><? endif;
                        echo htmlspecialcharsEx($field['name']) ?></div>
                    <div class="bx-crm-edit-title-wrapper">
                        <input type="text" class="bx-crm-edit-title" name="<?= htmlspecialcharsbx($field["id"]) ?>"
                               value="<?= isset($field['value']) ? htmlspecialcharsbx($field['value']) : '' ?>" <?= $params ?>/>
                    </div>
                    </div><?
                endforeach;
                unset($field);
            ...
            <div class="bx-crm-edit-content-block" id="<?= $arSection['SECTION_ID'] ?>">
                <div class="bx-crm-edit-content-block-title"><? if ($required):?><span
                            class="required">*</span><?endif; ?><?= htmlspecialcharsbx($arSection['SECTION_NAME']) ?>
                </div><?
                ...
                if ($field['type'] === 'vertical_container'):
                    ...
                    <div class="bx-crm-edit-content-block-vertical-element-name"><? if ($required):?><span
                ...
                elseif ($field['type'] === 'vertical_checkbox'):
                    ...
                    <input type="checkbox" class="bx-crm-edit-content-checkbox" name="<?= $field['id'] ?>"
                           value="Y" <?= (($val === true || $val === 'Y') ? ' checked' : '') ?><?= $params ?>/>
                    <div class="bx-crm-edit-content-checkbox-label"><? if ($required):?><span
                                class="required">*</span><? endif;
                        echo htmlspecialcharsEx($field['name']) ?></div>
                ...
                ?>
                <div<?= isset($field['hidden']) ? ' id="hidden_' . $field['id'] . '"' : '' ?>
                        class="<?= $isWide ? 'bx-crm-edit-content-block-wide-element' : 'bx-crm-edit-content-block-element' ?>"><?
                    ...
                    if (!$isWide):
                        ...
                        ?><span class="bx-crm-edit-content-block-element-name"><? if ($required):?><span
                            class="required">*</span><? endif;
                        if (isset($field['nameWrapper'])): echo '<span id="', htmlspecialcharsbx($field['nameWrapper']), '">', htmlspecialcharsEx($field['name']), '</span>'; else: echo htmlspecialcharsEx($field['name']); endif; ?>
                        :</span><?
                    endif;
                    ...
                    case 'date':
                        $APPLICATION->IncludeComponent(
                            ...
                            array(
                                "SHOW_INPUT" => "Y",
                                "INPUT_NAME" => $field["id"],
                                'INPUT_ADDITIONAL_ATTR' => 'class="form-control" placeholder="' . FormatDate("SHORT") . '" onkeyup="smartFilter.keyup(this)" onchange="smartFilter.keyup(this)"',
                                "INPUT_VALUE" => $val,
                                "SHOW_TIME" => 'Y'
                            ),
                            $component,
                    ...
                    case 'date_link':
                        ...
                        <input id="<?= htmlspecialcharsbx($dataID) ?>" type="hidden"
                               name="<?= htmlspecialcharsbx($field['id']) ?>" value="<?= $valEncoded ?>" <?= $params ?>>
                    ...
                    case 'intranet_user_search':
                        ...
                        if (!empty($params)):
                            ...
                            ?><input type="text" class="bx-crm-edit-input"
                        ...
                        if (!empty($params)):
                            ...
                            <div id="<?= htmlspecialcharsbx($containerID) ?>" class="bx-crm-edit-crm-entity-field">
                                <div class="bx-crm-entity-info-wrapper"><?
                                    if ($entityID > 0):
                                        ?><a href="<?= htmlspecialcharsbx($entityInfo['URL']) ?>" target="_blank"
                                             class="bx-crm-entity-info-link"><?= htmlspecialcharsEx($entityInfo['TITLE']) ?></a>
                                        <span class="crm-element-item-delete"></span><?
                                    endif;
                                    ?></div>
                                <input type="hidden" id="<?= htmlspecialcharsbx($dataInputID) ?>"
                                       name="<?= htmlspecialcharsbx($dataInputName) ?>" value="<?= $entityID ?>"/><?
                                if ($newDataInputName !== ''):
			...
			<span class="webform-button webform-button-create">
				...
				<span class="webform-button-right"></span>
                    ...
                    if (isset($arParams['IS_NEW']) && $arParams['IS_NEW'] === true):
                        ...
                        <span class="webform-button-left"></span>
				<input class="webform-button-text" type="submit" name="saveAndAdd"
    ...
    if ($GLOBALS['USER']->IsAuthorized() && $arParams["SHOW_SETTINGS"] == true):?>
        ...
        <div id="form_settings_<?= $arParams["FORM_ID"] ?>">
            <table width="100%">
                <tr class="section">
                    <td
                    <? echo GetMessage("interface_form_tabs") ?></td>
                </tr>
                <tr>
                    <td align="center">
                        <table>
                ...
                <? if ($arResult["IS_ADMIN"]):?>
                    ...
                    <tr>
                        <td><input type="checkbox" name="set_default_settings"
                                   id="set_default_settings_<?= $arParams["FORM_ID"] ?>"
                                   onclick="BX('delete_users_settings_<?= $arParams["FORM_ID"] ?>').disabled = !this.checked;"><label
                                    for="set_default_settings_<?= $arParams["FORM_ID"] ?>"><? echo GetMessage("interface_form_common_set") ?></label>
                        </td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" name="delete_users_settings"
                                   id="delete_users_settings_<?= $arParams["FORM_ID"] ?>" disabled><label
                                    for="delete_users_settings_<?= $arParams["FORM_ID"] ?>"><? echo GetMessage("interface_form_common_del") ?></label>
                        </td>
                    </tr>
                <?endif; ?>
            </table>
    ...
    ?>
        <script type="text/javascript">
            ...
            <?
            if($arParams["SHOW_SETTINGS"] == true):
            ?>bxForm_<?=$arParams["FORM_ID"]?>.settingsMenu.push({
                'TEXT': '<?=CUtil::JSEscape(GetMessage("intarface_form_mnu_settings"))?>',
                'TITLE': '<?=CUtil::JSEscape(GetMessage("intarface_form_mnu_settings_title"))?>',
            ...
            ?>bxForm_<?=$arParams["FORM_ID"]?>.settingsMenu.push({
                'TEXT': '<?=CUtil::JSEscape(GetMessage("intarface_form_mnu_on"))?>',
                'TITLE': '<?=CUtil::JSEscape(GetMessage("intarface_form_mnu_on_title"))?>',
            ...
            ?>bxForm_<?=$arParams["FORM_ID"]?>.settingsMenu.push({
                'TEXT': '<?=CUtil::JSEscape(GetMessage("intarface_form_mnu_off"))?>',
                'TITLE': '<?=CUtil::JSEscape(GetMessage("intarface_form_mnu_off_title"))?>',
