...
use MAsset;
use Nms\Asset\Entity\AssetHistoryTable;
use Nms\Asset\Entity\AssetStockTable;
use Nms\Asset\Entity\AssetTable;
...
?>
    <div class="let-card-head">Thông tin</div>
    <div id="<?= $undoContainerID ?>"></div>
    <div id="<?= $containerID ?>"
         class="bx-interface-form bx-crm-edit-form"<?= !$isVisible ? ' style="display:none;"' : '' ?>>
        <script type="text/javascript">
            var bxForm_<?=$arParams['FORM_ID']?> = null;
        </script><?
        if ($arParams['SHOW_FORM_TAG']):
        ?>
        <form name="form_<?= $arParams['FORM_ID'] ?>" id="form_<?= $arParams["FORM_ID"] ?>"
              action="<?= POST_FORM_ACTION_URI ?>" method="post" enctype="multipart/form-data">
            <?= bitrix_sessid_post(); ?>
            <input type="hidden" id="<?= $arParams["FORM_ID"] ?>_active_tab"
                   name="<?= $arParams["FORM_ID"] ?>_active_tab"
            ...
            <div id="<?= $sectionWrapperID ?>" class="crm-offer-main-wrap"><?
                ...
                foreach ($arSections as &$arSection):
                    ...
                    ?>
                    <table id="<?= $sectionNodePrefix ?>_contents"
                           class="crm-offer-info-table<?= $mode === 'VIEW' ? ' crm-offer-main-info-text' : '' ?>">
                    <tbody><?
                    ...
                    foreach ($arSection['FIELDS'] as &$field):
                        ...
                        ?>
                        <tr id="<?= $rowContainerID ?>"<?= $visible ? '' : 'style="display:none;"' ?>
                        class="<?= $containerClassName ?>"
                        data-dragdrop-context="field" data-dragdrop-id="<?= $field["id"] ?>"<?= $dragDropType !== '' ? ' data-dragdrop-type="' . $dragDropType . '"' : '' ?>>
                        <?
                                    ...
                                    <div class="crm-offer-requisite-form-wrap">
                                        <div class="crm-multi-address"><?
                                            foreach ($addressData as $addressTypeID => $addresFields):
                                                ...
                                                ?>
                                                <div class="crm-multi-address-item"
                                                     id="<?= htmlspecialcharsbx($itemWrapperID) ?>">
                                                <table class="crm-offer-info-table">
                                                    ...
                                                    foreach ($addressScheme as $addressSchemeItem):
                                                        ...
                                                        if ($addresFieldType === 'locality'):
                                                            ...
                                                            <td colspan="4">
                                                                <input type="hidden"
                                                                       name="<?= $addresFieldQualifiedName ?>"
                                                                       value="<?= htmlspecialcharsbx($addresFieldValue) ?>"/>
                                                                <script type="text/javascript">
                                                                    BX.ready(
                                                                        function () {
                                                            ...
                                                            <td class="crm-offer-info-right">
                                                                <div class="crm-offer-info-data-wrap"><?
                                                                    if ($addresFieldType === 'multilinetext'):?>
                                                                        <textarea class="bx-crm-edit-text-area"
                                                                                  name="<?= htmlspecialcharsEx($addresFieldQualifiedName) ?>"><?= htmlspecialcharsbx($addresFieldValue) ?></textarea><?
                                                                    else:?>
                                                                        <input class="crm-offer-item-inp"
                                                                               name="<?= htmlspecialcharsEx($addresFieldQualifiedName) ?>"
                                                                               type="text"
                                                                               value="<?= htmlspecialcharsbx($addresFieldValue) ?>"/>
                                                                    <?endif;
                                                                    ?></div>
                                        ...
                                        <td class="crm-offer-info-right">
                                            <div class="crm-offer-info-data-wrap"><?
                                                if (is_array($itemLocality)):
                                                    ...
                                                    ?><input class="crm-offer-item-inp" id="<?= $searchInputID ?>"
                                                             name="<?= $itemName ?>" type="text"
                                                             value="<?= htmlspecialcharsbx($itemValue) ?>"/>
                                                    <input type="hidden" id="<?= $dataInputID ?>"
                                                           name="<?= $itemLocality['NAME'] ?>"
                                                           value="<?= htmlspecialcharsbx($itemLocality['VALUE']) ?>"/>
                                                    <script type="text/javascript">
                                                        BX.ready(
                                                            function () {
                                                                BX.CrmLocalitySearchField.create(
                                                    ...
                                                    if (isset($item['IS_MULTILINE']) && $item['IS_MULTILINE']):
                                                        ?><textarea class="bx-crm-edit-text-area"
                                                                    name="<?= htmlspecialcharsEx($itemName) ?>"><?= htmlspecialcharsbx($itemValue) ?></textarea><?
                                                    else:
                                                        ?><input class="crm-offer-item-inp"
                                                                 name="<?= htmlspecialcharsEx($itemName) ?>" type="text"
                                                                 value="<?= htmlspecialcharsbx($itemValue) ?>" /><?
                                                    endif;
                                                endif;
                                                ?></div>
                        ...
                        <?
                            ...
                            ?>
                            <td class="crm-offer-info-left">
                            <div class="crm-offer-info-label-wrap"><span
                                        class="crm-offer-info-label-alignment"></span><span
                                        class="crm-offer-info-label">
					<? if ($required):?><span class="required">*</span><?endif; ?>
                        ...
                        switch ($field['type']):
                            case 'label':
                                ...
                                break;
                            case 'description':
                                echo '<div id="' . $field["id"] . '" class="crm-fld-block-readonly">', nl2br($val), '</div>';
                                break;
                            case 'listFiles':
                                ?>
                                <ol class="webform-field-upload-list webform-field-upload-list-multiple"
                                    id="mfi-meeting_uploader">
                                    <? foreach ($field["value"] as $item): ?>
                                        <li class="saved">
                                            <div class="webform-field-item-wrap">
                                    <span class="webform-field-upload-icon webform-field-upload-icon-pdf">
                                    <a href="<?= $item['link'] ?>" target="_blank" data-bx-role="file-name"
                                       class="upload-file-name"><?= $item['name'] ?></a>
                                    <span class="upload-file-size" data-bx-role="file-size"><?= $item['size'] ?></span>
                                            </div>
                                        </li>
                                    <? endforeach; ?>
                                </ol>
                        ...
                        if ($isUserField):
                            ...
                            case 'vertical_checkbox':
                                ...
                                <input class="crm-offer-checkbox" type="checkbox" id="<?= $chkBxId ?>"
                                       name="<?= $field['id'] ?>"
                                       value="Y"<?= ($val == 'Y' ? ' checked' : '') ?><?= $params ?>/>
                                <label class="crm-offer-label"
                                       for="<?= $chkBxId ?>"><?= htmlspecialcharsEx($field['name']) ?></label><?
                                break;
                            case 'textarea':
                                ?><textarea
                                class="bx-crm-edit-text-area" name="<?= $field["id"] ?>"<?= $params ?>><?= $valEncoded ?></textarea><?
                                break;
                            case 'list':
                                ?>
                                <select class="crm-item-table-select" id="<?= $field["id"] ?>" name="<?= $field["id"] ?>"<?= $params ?>>
                                    <option value="">---</option>
                                <?
                            ...
                            <select class="crm-item-table-select" id="<?= $field["id"] ?>" name="<?= $field["id"] ?>"<?= $params ?>>
                                ...
                                if (is_array($field["items"])):
                                    foreach ($field["items"] as $k => $v):
                                        ?>
                                        <option value="<?= htmlspecialcharsbx($v['id']) ?>"<?= ($v['id'] == $field['value'] ? ' selected' : '') ?>><?= htmlspecialcharsEx($v['name']) ?></option><?
                                    endforeach;
                                endif;
                                ?></select><?
                                break;
                            ...
                            <select class="crm-item-table-select" id="<?= $field["id"] ?>" name="<?= $field["id"] ?>"<?= $params ?>>
                                ...
                                break;
                            case 'listTime':
                                ?><select class="crm-item-time-select" name="<?= $field["id"] ?>"<?= $params ?>><?
                                if (is_array($field["items"])):
                                    if (!is_array($val))
                                        $val = array($val);
                                    $val = array_map("strval", $val);
                            ...
                            case 'file':
                                ...
                                foreach ($arDefParams as $k => $v)
                                    if (!array_key_exists($k, $field["params"]))
                                        $field["params"][$k] = $v;
                                echo CFile::InputFile($field["id"], $field["params"]["size"], '');
                                if ($val <> '')
                            ...
                            case 'date':
                                ...
                                ?><input id="<?= $fieldId ?>" name="<?= $fieldId ?>"
                                         class="crm-offer-item-inp crm-item-table-date" type="text"
                                         value="<?= $valEncoded ?>"/>
                                <script type="text/javascript">
                                    BX.ready(function () {
                                        BX.CrmDateLinkField.create(BX('<?=CUtil::JSEscape($fieldId)?>'), null, {
                                            showTime: true,
                            ...
                            case 'get_user':
                                ...
                                $APPLICATION->IncludeComponent(
                                    ...
                                    [
                                        ...
                                        "BUTTON_SELECT_CAPTION" => 'Chọn người phê duyệt',
                                        "SELECTOR_OPTIONS" =>
                                            [
                            ...
                            case 'date_link':
                                ...
                                ?><span id="<?= htmlspecialcharsbx($viewID) ?>"
                                        class="bx-crm-edit-datetime-link"><?= htmlspecialcharsEx($val !== '' ? $val : GetMessage('interface_form_set_datetime')) ?></span>
                                <input id="<?= htmlspecialcharsbx($dataID) ?>" type="hidden"
                                       name="<?= htmlspecialcharsbx($field['id']) ?>"
                                       value="<?= $valEncoded ?>" <?= $params ?>>
                                <script type="text/javascript">BX.ready(function () {
                                        BX.CrmDateLinkField.create(BX('<?=CUtil::addslashes($dataID)?>'), BX('<?=CUtil::addslashes($viewID)?>'), {showTime: false});
                                    });</script><?
                                break;
                            case 'user_pay':
                                $department = MAsset::getUserByDepartment($field['department_id']);
                                ?>
                                <select class="form-control chosen-select" multiple
                                        data-placeholder="<?= $field['lang'] ?>" name="user_pay[]"
                                        id="<?= $field["id"] ?>">
                                    <? foreach ($department as $val): ?>
                                        <option <? if (in_array($val['ID'], $field["value"])): ?>selected<? endif; ?>
                                                data-img-src="<? echo $val['IMAGE']; ?>"
                                                value="<? echo $val['ID'] ?>"><?= $val['NAME'] ?></option>
                                    <? endforeach; ?>
                                </select>
                                <?
                                break;
                            case 'user_take':
                                ...
                                ?>
                                <select class="form-control chosen-select" multiple
                                        data-placeholder="<?= $field['lang'] ?>" name="user_take[]"
                                        id="<?= $field["id"] ?>">
                                    <? foreach ($department as $val): ?>
                                        <option <? if (in_array($val['ID'], $field["value"])): ?>selected<? endif; ?>
                                                data-img-src="<? echo $val['IMAGE']; ?>"
                            ...
                            case 'asset':
                                $asset = [];
                                if ($field['stock']) {
                                    $stock = AssetStockTable::getList(['filter' => ['inventory_id' => $field['stock']], 'select' => ['asset_id']])->fetchAll();
                                    if ($field['editId'] > 0) {
                                        $history = AssetHistoryTable::getList(['filter' => ['delivery_id' => $field['editId']], 'select' => ['asset_id']])->fetchAll();
                                        $stock = array_merge($stock, $history);
                                    }
                                    foreach ($stock as $item) {
                                        $asset[] = AssetTable::getAssetByStock($item['asset_id']);
                                    }
                                }
                                ?>
                                <select class="form-control chosen-select" multiple
                                        data-placeholder="<?= $field['lang'] ?>" name="asset[]"
                                        id="<?= $field["id"] ?>">
                            ...
                            case 'intranet_user_search':
                                ...
                                if (!empty($params)):
                                    ...
                                    ?><input type="text" class="crm-offer-item-inp"
                                             name="<?= htmlspecialcharsbx($params['SEARCH_INPUT_NAME']) ?>">
                                    <input type="hidden" name="<?= htmlspecialcharsbx($params['INPUT_NAME']) ?>"
                                           value="<?= $valEncoded ?>"><?
                            ...
                            case 'crm_entity_selector':
                                ...
                                if (!empty($params)):
                                    ...
                                    <div id="<?= htmlspecialcharsbx($containerID) ?>"
                                         class="bx-crm-edit-crm-entity-field">
                                        <div class="bx-crm-entity-info-wrapper"></div>
                                        <input type="hidden" id="<?= htmlspecialcharsbx($dataInputID) ?>"
                                               name="<?= htmlspecialcharsbx($dataInputName) ?>"
                                               value="<?= $entityID ?>"/><?
                                        if ($newDataInputName !== ''):
                                            ?><input type="hidden" id="<?= htmlspecialcharsbx($newDataInputID) ?>"
                                                     name="<?= htmlspecialcharsbx($newDataInputName) ?>"
                                                     value="<?= $newEntityID ?>" /><?
                                        endif;
                                        if ($requireRequisiteData) {
                                            ...
                                            ?><input type="hidden" id="<?= htmlspecialcharsbx($rqLinkedInputId) ?>"
                                                     name="<?= htmlspecialcharsbx($rqLinkedInputName) ?>"
                                                     value="<?= $rqLinkedId ?>" /><?
                                            ...
                                            ?><input type="hidden" id="<?= htmlspecialcharsbx($bdLinkedInputId) ?>"
                                                     name="<?= htmlspecialcharsbx($bdLinkedInputName) ?>"
                                                     value="<?= $bdLinkedId ?>" /><?
                                        }
                                        ?>
                                        <div class="bx-crm-entity-buttons-wrapper">
                                            <span id="<?= htmlspecialcharsbx($changeButtonID) ?>"
                                                  class="bx-crm-edit-crm-entity-change"><?= htmlspecialcharsbx(GetMessage('intarface_form_select')) ?></span><?
                                            if ($newDataInputName !== ''):
                                                ?> <span
                                                    class="bx-crm-edit-crm-entity-add"><?= htmlspecialcharsEx(GetMessage('interface_form_add_new_entity')) ?></span><?
                                            endif;
                                            ?></div>
                                    </div><?
                                    $serviceUrl = '';
                            ...
                            case 'crm_client_selector':
                                ...
                                if (!empty($params)) {
                                    ...
                                    <div id="<?= htmlspecialcharsbx($containerID) ?>"
                                        ...
                                        <? if ($newDataInputName !== ''): ?>
                                            <input type="hidden" id="<?= htmlspecialcharsbx($newDataInputID) ?>"
                                                   name="<?= htmlspecialcharsbx($newDataInputName) ?>" value=""/>
                                        <? endif;
                                        if ($requireRequisiteData) {
                                            $rqLinkedInputName = '';
                                            if (isset($params['REQUISITE_INPUT_NAME'])) {
                                        ...
                                        <? if ($newDataInputName !== ''): ?>
                                            <br>
                                            <span id="<?= htmlspecialcharsbx($createEntitiesBlockID) ?>"
                                                  class="bx-crm-edit-description"<?= ($entityID > 0) ? ' style="display: none;"' : '' ?>>
									<span><?= htmlspecialcharsEx(GetMessage('interface_form_add_new_entity')) ?> </span>
									<span id="<?= htmlspecialcharsbx($addCompanyButtonID) ?>"
                                          class="bx-crm-edit-crm-entity-add"><?= htmlspecialcharsbx(GetMessage('interface_form_add_btn_company')) ?></span>
									<span><?= htmlspecialcharsbx(' ' . GetMessage('interface_form_add_btn_or')) . ' ' ?></span>
									<span id="<?= htmlspecialcharsbx($addContactButtonID) ?>"
                                          class="bx-crm-edit-crm-entity-add"><?= htmlspecialcharsbx(GetMessage('interface_form_add_btn_contact')) ?></span>
									</span>
                                        <? endif; ?>
                                        <!--</div>-->
                                    </div><?
                            ...
                            case 'crm_multiple_client_selector':
                                {
                                    ...
                                    if (!empty($params)) {
                                        ...
                                        ?>
                                        <input type="hidden" id="<?= htmlspecialcharsbx($entitiesInputID) ?>"
                                               name="<?= htmlspecialcharsbx($entitiesInputName) ?>"
                                               value="<?= implode(',', $entityIDs) ?>"/>
                                        <?
                                                ...
                                                function () {
                                                    ...
                                                    BX.CrmMultipleClientSelector.create(
                                                        "<?=CUtil::JSEscape($field['id'])?>",
                                                        {
                                                            ...
                                                            owner: {
                                                                id: "<?=$ownerID?>",
                                                                typeName: "<?=CUtil::JSEscape($ownerType)?>"
                                                            },
                            ...
                            case 'crm_single_client_selector':
                                {
                                    ...
                                    if (!empty($params)) {
                                        ...
                                        if ($readOnly) {
                                            ...
                                            ?>
                                            <input type="hidden" id="<?= htmlspecialcharsbx($entityInputID) ?>"
                                                   name="<?= htmlspecialcharsbx($entityInputName) ?>"
                                                   value="<?= $entityID ?>"/>
                                            <input type="hidden" id="<?= htmlspecialcharsbx($requisiteInputID) ?>"
                                                   name="<?= htmlspecialcharsbx($requisiteInputName) ?>"
                                                   value="<?= $requisiteID ?>"/>
                                            <input type="hidden" id="<?= htmlspecialcharsbx($bankDetailInputID) ?>"
                                                   name="<?= htmlspecialcharsbx($bankDetailInputName) ?>"
                                                   value="<?= $bankDetailID ?>"/>
                                            <?
                                        }
                            ...
                            case 'crm_composite_client_selector':
                                {
                                    ...
                                    if (!empty($params)) {
                                        ...
                                        if ($readOnly) {
                                            ...
                                            ?>
                                            <input type="hidden"
                                                   id="<?= htmlspecialcharsbx($primaryEntityTypeInpuID) ?>"
                                                   name="<?= htmlspecialcharsbx($primaryEntityTypeInputName) ?>"
                                                   value="<?= $primaryEntityType ?>"/>
                                            <input type="hidden" id="<?= htmlspecialcharsbx($primaryEntityInputID) ?>"
                                                   name="<?= htmlspecialcharsbx($primaryEntityInputName) ?>"
                                                   value="<?= $primaryEntityID ?>"/>
                                            <input type="hidden"
                                                   id="<?= htmlspecialcharsbx($secondaryEntitiesInputID) ?>"
                                                   name="<?= htmlspecialcharsbx($secondaryEntitiesInputName) ?>"
                                                   value="<?= implode(',', $secondaryEntityIDs) ?>"/>
                                            <input type="hidden" id="<?= htmlspecialcharsbx($requisiteInputID) ?>"
                                                   name="<?= htmlspecialcharsbx($requisiteInputName) ?>"
                                                   value="<?= $requisiteID ?>"/>
                                            <input type="hidden" id="<?= htmlspecialcharsbx($bankDetailInputID) ?>"
                            ...
                            case 'crm_locality_search':
                                ...
                                ?><input type="text" class="crm-offer-item-inp" id="<?= $searchInputID ?>"
                                         name="<?= $field["id"] ?>" name="<?= $field["id"] ?>"
                                         value="<?= $valEncoded ?>"<?= $params ?>/>
                                <input type="hidden" id="<?= $dataInputID ?>" name="<?= $params['DATA_INPUT_NAME'] ?>"
                                       value="<?= htmlspecialcharsbx($params['DATA_VALUE']) ?>"/>
                                <script type="text/javascript">
                                    BX.ready(
                                        function () {
                                            BX.CrmLocalitySearchField.create(
                            ...
                            case 'get_info_user':
                                $APPLICATION->IncludeComponent(
                                    ...
                                    ' ',
                                    [
                                        "ID" => "listMemberToExclude_".$field['id'],
                                        "API_VERSION" => 3,
                                        "LIST" => $field['value'],
                                        "INPUT_NAME" => $field['id'].$field['array'],
                                        "USE_SYMBOLIC_ID" => true,
                                        "BUTTON_SELECT_CAPTION" => 'Chọn',
                                        "SELECTOR_OPTIONS" =>
                                            [
                                                "departmentSelectDisable" => "Y",
                                                'context' => 'MAIL_CLIENT_CONFIG_QUEUE',
                            ...
                            case 'file_upload_':
                                ?>
                                <input type="hidden" name="pdf_base64" class="pdf_base64">
                                <input id="file-input" type="file" name="file" onchange="onUpload(this)" />
                                <div id="display-pdf"></div>
                                <?
                                break;
                            default:
                                ?><input type="text" class="crm-offer-item-inp" <?=isset($field['disable']) ? 'disabled': ''?>
                                         name="<?= $field["id"] ?>" value="<?= $valEncoded ?>"<?= $params ?>><?
                        endswitch;
                            ?></div><?
                            if ($advancedInfoHTML !== '')
                        ...
                        <td class="crm-offer-info-right">
                            <div class="crm-offer-item-link-wrap">
                                <? if ($canCreateUserField): ?>
                                    <span id="<?= $sectionNodePrefix ?>_add_field"
                                          class="crm-offer-info-link"><?= GetMessage('interface_form_add_btn_add_field') ?></span>
                                <? endif; ?>
                                <? if ($canCreateSection): ?>
                                    <span id="<?= $sectionNodePrefix ?>_add_section"
                                          class="crm-offer-info-link"><?= GetMessage('interface_form_add_btn_add_section') ?></span>
                                <? endif; ?>
                                <span id="<?= $sectionNodePrefix ?>_restore_field"
                                      class="crm-offer-info-link"><?= GetMessage('interface_form_add_btn_restore_field') ?></span>
                            </div>
                        </td>
                        <td class="crm-offer-info-right-btn"></td>
                        <td class="crm-offer-last-td"></td>
                ...
                if (!empty($arFieldSets)):
                    foreach ($arFieldSets as &$arFieldSet):
                        ...
                        <h2 class="bx-crm-view-fieldset-title"><? if (isset($arFieldSet['REQUIRED']) && $arFieldSet['REQUIRED'] === true): ?>
                                <span class="required">*</span><? endif; ?><?= isset($arFieldSet['NAME']) ? htmlspecialcharsbx($arFieldSet['NAME']) : '' ?>
                        </h2>
            ...
            if (isset($arParams['~BUTTONS'])):
                if (isset($arParams['~BUTTONS']['standard_buttons']) && $arParams['~BUTTONS']['standard_buttons']):
                    ...
                    <input class="ui-btn ui-btn-success" type="submit" name="saveAndView"
                           id="<?= $arParams["FORM_ID"] ?>_saveAndView"
                           value="<?= htmlspecialcharsbx($buttonsTitles['saveAndView']['value']) ?>"
                           title="<?= htmlspecialcharsbx($buttonsTitles['saveAndView']['title']) ?>" /><?
                    if (isset($arParams['IS_NEW']) && $arParams['IS_NEW'] === true):
                        ?><input class="ui-btn ui-btn-success" type="submit" name="saveAndAdd"
                                 id="<?= $arParams["FORM_ID"] ?>_saveAndAdd"
                                 value="<?= htmlspecialcharsbx($buttonsTitles['saveAndAdd']['value']) ?>"
                                 title="<?= htmlspecialcharsbx($buttonsTitles['saveAndAdd']['title']) ?>" /><?
                    else:
                        ?><input class="ui-btn ui-btn-light-border" type="submit" name="apply"
                                 id="<?= $arParams["FORM_ID"] ?>_apply"
                                 value="<?= htmlspecialcharsbx($buttonsTitles['apply']['value']) ?>"
                                 title="<?= htmlspecialcharsbx($buttonsTitles['apply']['title']) ?>" /><?
                    endif;
                    if (isset($arParams['~BUTTONS']['back_url']) && $arParams['~BUTTONS']['back_url'] !== ''):
                        ?><input class="ui-btn ui-btn-link" type="button" name="cancel"
                                 onclick="window.location='<?= CUtil::JSEscape($arParams['~BUTTONS']['back_url']) ?>'"
                                 value="<?= htmlspecialcharsbx($buttonsTitles['cancel']['value']) ?>"
                                 title="<?= htmlspecialcharsbx($buttonsTitles['cancel']['title']) ?>" /><?
                    endif;
                    ?></div><?
                elseif (isset($arParams['~BUTTONS']['wizard_buttons']) && $arParams['~BUTTONS']['wizard_buttons']):
                    ...
                    ?>
                    <div class="ui-btn-container ui-btn-container-center">
                    <input class="ui-btn ui-btn-success" type="submit" name="continue"
                           id="<?= $arParams["FORM_ID"] ?>_continue"
                           value="<?= htmlspecialcharsbx($buttonsTitles['continue']['value']) ?>"
                           title="<?= htmlspecialcharsbx($buttonsTitles['continue']['title']) ?>" /><?
                    if (isset($arParams['~BUTTONS']['back_url']) && $arParams['~BUTTONS']['back_url'] !== ''):
                        ?><input class="ui-btn ui-btn-link" type="button" name="cancel"
                                 onclick="window.location='<?= CUtil::JSEscape($arParams['~BUTTONS']['back_url']) ?>'"
                                 value="<?= htmlspecialcharsbx($buttonsTitles['cancel']['value']) ?>"
                ...
                elseif (isset($arParams['~BUTTONS']['dialog_buttons']) && $arParams['~BUTTONS']['dialog_buttons']):
                    ...
                    ?>
                    <div class="ui-btn-container ui-btn-container-center">
                    <input class="ui-btn ui-btn-success" type="submit" name="save" id="<?= $arParams["FORM_ID"] ?>_save"
                           value="<?= htmlspecialcharsbx($buttonsTitles['save']['value']) ?>"
                           title="<?= htmlspecialcharsbx($buttonsTitles['save']['title']) ?>"/>
                    <input class="ui-btn ui-btn-link" type="submit" name="cancel"
                           id="<?= $arParams["FORM_ID"] ?>_cancel"
                           value="<?= htmlspecialcharsbx($buttonsTitles['cancel']['value']) ?>"
                           title="<?= htmlspecialcharsbx($buttonsTitles['cancel']['title']) ?>"/>
                    </div><?
                endif;
                        ...
                        <table>
                            <tr>
                                <td style="background-image:none" nowrap>
                                    <select style="min-width:150px;" name="tabs" size="10"
                                            ondblclick="this.form.tab_edit_btn.onclick()"
                                            onchange="bxForm_<?= $arParams["FORM_ID"] ?>.OnSettingsChangeTab()">
                                    </select>
                                </td>
                                <td style="background-image:none">
                                    <div style="margin-bottom:5px"><input type="button" name="tab_up_btn"
                                                                          value="<? echo GetMessage("intarface_form_up") ?>"
                                                                          title="<? echo GetMessage("intarface_form_up_title") ?>"
                                                                          style="width:80px;"
                                                                          onclick="bxForm_<?= $arParams["FORM_ID"] ?>.TabMoveUp()">
                                    </div>
                                    <div style="margin-bottom:5px"><input type="button" name="tab_down_btn"
                                                                          value="<? echo GetMessage("intarface_form_up_down") ?>"
                                                                          title="<? echo GetMessage("intarface_form_down_title") ?>"
                                                                          style="width:80px;"
                                                                          onclick="bxForm_<?= $arParams["FORM_ID"] ?>.TabMoveDown()">
                                    </div>
                                    <div style="margin-bottom:5px"><input type="button" name="tab_add_btn"
                                                                          value="<? echo GetMessage("intarface_form_add") ?>"
                                                                          title="<? echo GetMessage("intarface_form_add_title") ?>"
                                                                          style="width:80px;"
                                                                          onclick="bxForm_<?= $arParams["FORM_ID"] ?>.TabAdd()">
                                    </div>
                                    <div style="margin-bottom:5px"><input type="button" name="tab_edit_btn"
                                                                          value="<? echo GetMessage("intarface_form_edit") ?>"
                                                                          title="<? echo GetMessage("intarface_form_edit_title") ?>"
                                                                          style="width:80px;"
                                                                          onclick="bxForm_<?= $arParams["FORM_ID"] ?>.TabEdit()">
                                    </div>
                                    <div style="margin-bottom:5px"><input type="button" name="tab_del_btn"
                                                                          value="<? echo GetMessage("intarface_form_del") ?>"
                                                                          title="<? echo GetMessage("intarface_form_del_title") ?>"
                                                                          style="width:80px;"
                                                                          onclick="bxForm_<?= $arParams["FORM_ID"] ?>.TabDelete()">
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table>
                            <tr>
                                <td style="background-image:none" nowrap>
                                    ...
                                    <select style="min-width:150px;" name="all_fields" multiple size="12"
                                            ondblclick="this.form.add_btn.onclick()"
                                            onchange="bxForm_<?= $arParams["FORM_ID"] ?>.ProcessButtons()">
                                    </select>
                                </td>
                                <td style="background-image:none">
                                    <div style="margin-bottom:5px"><input type="button" name="add_btn" value="&gt;"
                                                                          title="<? echo GetMessage("intarface_form_add_field") ?>"
                                                                          style="width:30px;" disabled
                                                                          onclick="bxForm_<?= $arParams["FORM_ID"] ?>.FieldsAdd()">
                                    </div>
                                    <div style="margin-bottom:5px"><input type="button" name="del_btn" value="&lt;"
                                                                          title="<? echo GetMessage("intarface_form_del_field") ?>"
                                                                          style="width:30px;" disabled
                                                                          onclick="bxForm_<?= $arParams["FORM_ID"] ?>.FieldsDelete()">
                                    </div>
                                </td>
                                <td style="background-image:none" nowrap>
                                    <div style="margin-bottom:5px"><? echo GetMessage("intarface_form_fields_on_tab") ?></div>
                                    <select style="min-width:150px;" name="fields" multiple size="12"
                                            ondblclick="this.form.del_btn.onclick()"
                                            onchange="bxForm_<?= $arParams["FORM_ID"] ?>.ProcessButtons()">
                                    </select>
                                </td>
                                <td style="background-image:none">
                                    <div style="margin-bottom:5px"><input type="button" name="up_btn"
                                                                          value="<? echo GetMessage("intarface_form_up") ?>"
                                                                          title="<? echo GetMessage("intarface_form_up_title") ?>"
                                                                          style="width:80px;" disabled
                                                                          onclick="bxForm_<?= $arParams["FORM_ID"] ?>.FieldsMoveUp()">
                                    </div>
                                    <div style="margin-bottom:5px"><input type="button" name="down_btn"
                                                                          value="<? echo GetMessage("intarface_form_up_down") ?>"
                                                                          title="<? echo GetMessage("intarface_form_down_title") ?>"
                                                                          style="width:80px;" disabled
                                                                          onclick="bxForm_<?= $arParams["FORM_ID"] ?>.FieldsMoveDown()">
                                    </div>
                                    <div style="margin-bottom:5px"><input type="button" name="field_add_btn"
                                                                          value="<? echo GetMessage("intarface_form_add") ?>"
                                                                          title="<? echo GetMessage("intarface_form_add_sect") ?>"
                                                                          style="width:80px;"
                                                                          onclick="bxForm_<?= $arParams["FORM_ID"] ?>.FieldAdd()">
                                    </div>
                                    <div style="margin-bottom:5px"><input type="button" name="field_edit_btn"
                                                                          value="<? echo GetMessage("intarface_form_edit") ?>"
                                                                          title="<? echo GetMessage("intarface_form_edit_field") ?>"
                                                                          style="width:80px;"
                                                                          onclick="bxForm_<?= $arParams["FORM_ID"] ?>.FieldEdit()">
                                    </div>
                                </td>
                            </tr>
                        </table>
    ...
    ?>
        <script type="text/javascript">
            ...
            ?>BX.ready(function () {
                bxForm_<?=$arParams["FORM_ID"]?>.ToggleTabs(true);
            });
            <?
            endif;
